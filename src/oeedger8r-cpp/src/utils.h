...
template <typename T>
void autogen_preamble_pop(T& os)
{
...
inline std::string pop_params(
    const Function* f,
    bool ecall = true,
    bool gen_t = true)                                      
{
        std::string retstr,auxstr;                                         
        int count = 0, aux = 0;
    ...
    for (Decl* p : f->params_){                                                   
        ...
        retstr = std::to_string(count) + auxstr;                                      
        
    return retstr;                                                                
}   

inline std::string pop_prototype(
    const Function* f,
    bool ecall = true,
    bool gen_t = true,
    const std::string& prefix = "")
{
    ...
    return retstr + " " + prefix + "__aux_pop_" +f->name_ + argsstr;
...
inline std::string raw_pop_create_prototype(const std::string& ename)
{
    return "__aux_pop_oe_create_" + ename + "_enclave";
}

inline std::string pop_create_prototype(const std::string& ename)
{
    return "oe_result_t __aux_pop_oe_create_" + ename + "_enclave(\n" +
           "    const char* path,\n"
