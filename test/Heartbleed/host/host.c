...
int recv_sm_data(int sock_desc, uint16_t length, uint8_t *buffer)
{
    uint8_t *ptr = buffer;
    int k = 0;
...
int main(int argc, const char* argv[])
{
    ...
    */
    ...
    enclave_protect_data(enclave,ret,data);

    /* Vulnerable OpenSSL! Under Heartbleed */ 
    ...
    enclave_restore_protected_data(enclave,ret,data);
