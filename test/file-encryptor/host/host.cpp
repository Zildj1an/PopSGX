...
int encrypt_file(
    bool encrypt, // ENCRYPT_OPERATION
    const char* password,
...
//    }
    ...
    ret = encrypt_file(
        ENCRYPT_OPERATION, "password", input_file, encrypted_file);
    ...
    ret = encrypt_file(
        ...
        "password",
        encrypted_file,
        decrypted_file); // TODO Send this back
    if (ret != 0)
    {
...
exit:
    ...
    //oe_terminate_enclave(enclave); // PopSGX already called this! 
