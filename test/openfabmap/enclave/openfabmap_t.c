...
enum
{
    openfabmap_fcn_id_open_settings_file = 0,
    openfabmap_fcn_id_oe_get_sgx_report_ecall = 1,
    openfabmap_fcn_id_oe_get_report_v2_ecall = 2,
    openfabmap_fcn_id_oe_verify_local_report_ecall = 3,
    openfabmap_fcn_id_oe_sgx_init_context_switchless_ecall = 4,
    openfabmap_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 5,
    openfabmap_fcn_id_trusted_call_id_max = OE_ENUM_MAX
};

#define MAX_POP_CALL_CUSTOM (1)

/**** ECALL marshalling structs. ****/
typedef struct _open_settings_file_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    int oe_retval;
} open_settings_file_args_t;
...
static void ecall_open_settings_file(
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    open_settings_file_args_t* _pargs_in = (open_settings_file_args_t*)input_buffer;
    open_settings_file_args_t* _pargs_out = (open_settings_file_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = open_settings_file(
    );
...
oe_ecall_func_t oe_ecalls_table[] = {
    (oe_ecall_func_t) ecall_open_settings_file,
...
enum
{
    openfabmap_fcn_id_oe_syscall_epoll_create1_ocall = 0,
    openfabmap_fcn_id_oe_syscall_epoll_wait_ocall = 1,
    openfabmap_fcn_id_oe_syscall_epoll_wake_ocall = 2,
    openfabmap_fcn_id_oe_syscall_epoll_ctl_ocall = 3,
    openfabmap_fcn_id_oe_syscall_epoll_close_ocall = 4,
    openfabmap_fcn_id_oe_syscall_open_ocall = 5,
    openfabmap_fcn_id_oe_syscall_read_ocall = 6,
    openfabmap_fcn_id_oe_syscall_write_ocall = 7,
    openfabmap_fcn_id_oe_syscall_readv_ocall = 8,
    openfabmap_fcn_id_oe_syscall_writev_ocall = 9,
    openfabmap_fcn_id_oe_syscall_lseek_ocall = 10,
    openfabmap_fcn_id_oe_syscall_pread_ocall = 11,
    openfabmap_fcn_id_oe_syscall_pwrite_ocall = 12,
    openfabmap_fcn_id_oe_syscall_close_ocall = 13,
    openfabmap_fcn_id_oe_syscall_flock_ocall = 14,
    openfabmap_fcn_id_oe_syscall_fsync_ocall = 15,
    openfabmap_fcn_id_oe_syscall_fdatasync_ocall = 16,
    openfabmap_fcn_id_oe_syscall_dup_ocall = 17,
    openfabmap_fcn_id_oe_syscall_opendir_ocall = 18,
    openfabmap_fcn_id_oe_syscall_readdir_ocall = 19,
    openfabmap_fcn_id_oe_syscall_rewinddir_ocall = 20,
    openfabmap_fcn_id_oe_syscall_closedir_ocall = 21,
    openfabmap_fcn_id_oe_syscall_stat_ocall = 22,
    openfabmap_fcn_id_oe_syscall_fstat_ocall = 23,
    openfabmap_fcn_id_oe_syscall_access_ocall = 24,
    openfabmap_fcn_id_oe_syscall_link_ocall = 25,
    openfabmap_fcn_id_oe_syscall_unlink_ocall = 26,
    openfabmap_fcn_id_oe_syscall_rename_ocall = 27,
    openfabmap_fcn_id_oe_syscall_truncate_ocall = 28,
    openfabmap_fcn_id_oe_syscall_ftruncate_ocall = 29,
    openfabmap_fcn_id_oe_syscall_mkdir_ocall = 30,
    openfabmap_fcn_id_oe_syscall_rmdir_ocall = 31,
    openfabmap_fcn_id_oe_syscall_fcntl_ocall = 32,
    openfabmap_fcn_id_oe_syscall_ioctl_ocall = 33,
    openfabmap_fcn_id_oe_syscall_poll_ocall = 34,
    openfabmap_fcn_id_oe_syscall_kill_ocall = 35,
    openfabmap_fcn_id_oe_syscall_close_socket_ocall = 36,
    openfabmap_fcn_id_oe_syscall_socket_ocall = 37,
    openfabmap_fcn_id_oe_syscall_shutdown_sockets_device_ocall = 38,
    openfabmap_fcn_id_oe_syscall_socketpair_ocall = 39,
    openfabmap_fcn_id_oe_syscall_connect_ocall = 40,
    openfabmap_fcn_id_oe_syscall_accept_ocall = 41,
    openfabmap_fcn_id_oe_syscall_bind_ocall = 42,
    openfabmap_fcn_id_oe_syscall_listen_ocall = 43,
    openfabmap_fcn_id_oe_syscall_recvmsg_ocall = 44,
    openfabmap_fcn_id_oe_syscall_sendmsg_ocall = 45,
    openfabmap_fcn_id_oe_syscall_recv_ocall = 46,
    openfabmap_fcn_id_oe_syscall_recvfrom_ocall = 47,
    openfabmap_fcn_id_oe_syscall_send_ocall = 48,
    openfabmap_fcn_id_oe_syscall_sendto_ocall = 49,
    openfabmap_fcn_id_oe_syscall_recvv_ocall = 50,
    openfabmap_fcn_id_oe_syscall_sendv_ocall = 51,
    openfabmap_fcn_id_oe_syscall_shutdown_ocall = 52,
    openfabmap_fcn_id_oe_syscall_setsockopt_ocall = 53,
    openfabmap_fcn_id_oe_syscall_getsockopt_ocall = 54,
    openfabmap_fcn_id_oe_syscall_getsockname_ocall = 55,
    openfabmap_fcn_id_oe_syscall_getpeername_ocall = 56,
    openfabmap_fcn_id_oe_syscall_getaddrinfo_open_ocall = 57,
    openfabmap_fcn_id_oe_syscall_getaddrinfo_read_ocall = 58,
    openfabmap_fcn_id_oe_syscall_getaddrinfo_close_ocall = 59,
    openfabmap_fcn_id_oe_syscall_getnameinfo_ocall = 60,
    openfabmap_fcn_id_oe_syscall_nanosleep_ocall = 61,
    openfabmap_fcn_id_oe_syscall_clock_nanosleep_ocall = 62,
    openfabmap_fcn_id_oe_syscall_getpid_ocall = 63,
    openfabmap_fcn_id_oe_syscall_getppid_ocall = 64,
    openfabmap_fcn_id_oe_syscall_getpgrp_ocall = 65,
    openfabmap_fcn_id_oe_syscall_getuid_ocall = 66,
    openfabmap_fcn_id_oe_syscall_geteuid_ocall = 67,
    openfabmap_fcn_id_oe_syscall_getgid_ocall = 68,
    openfabmap_fcn_id_oe_syscall_getegid_ocall = 69,
    openfabmap_fcn_id_oe_syscall_getpgid_ocall = 70,
    openfabmap_fcn_id_oe_syscall_getgroups_ocall = 71,
    openfabmap_fcn_id_oe_syscall_uname_ocall = 72,
    openfabmap_fcn_id_oe_get_supported_attester_format_ids_ocall = 73,
    openfabmap_fcn_id_oe_get_qetarget_info_ocall = 74,
    openfabmap_fcn_id_oe_get_quote_ocall = 75,
    openfabmap_fcn_id_oe_get_quote_verification_collateral_ocall = 76,
    openfabmap_fcn_id_oe_verify_quote_ocall = 77,
    openfabmap_fcn_id_oe_sgx_get_cpuid_table_ocall = 78,
    openfabmap_fcn_id_oe_sgx_backtrace_symbols_ocall = 79,
    openfabmap_fcn_id_oe_sgx_thread_wake_wait_ocall = 80,
    openfabmap_fcn_id_oe_sgx_wake_switchless_worker_ocall = 81,
    openfabmap_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 82,
    openfabmap_fcn_id_untrusted_call_max = OE_ENUM_MAX
};

#define MAX_POP_CALL_CUSTOM (0)
...
int is_pop_call(int fnc_id, int ecall)
{
     int ret = 1;
     if (!ecall) return 0;
    ...
    int flags)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_epoll_create1_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_epoll_create1_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_epoll_create1_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int timeout)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_epoll_wait_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_epoll_wait_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_epoll_wait_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_epoll_wake_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_epoll_wake_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_epoll_wake_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_epoll_wake_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_epoll_event* event)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_epoll_ctl_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_epoll_ctl_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_epoll_ctl_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t epfd)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_epoll_close_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_epoll_close_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_epoll_close_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_mode_t mode)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_open_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_open_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_open_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t count)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_read_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_read_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_read_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t count)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_write_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_write_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_write_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_readv_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_readv_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_readv_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_writev_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_writev_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_writev_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int whence)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_lseek_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_lseek_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_lseek_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t offset)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_pread_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_pread_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_pread_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t offset)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_pwrite_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_pwrite_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_pwrite_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t fd)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_close_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_close_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_close_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int operation)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_flock_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_flock_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_flock_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t fd)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_fsync_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_fsync_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_fsync_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t fd)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_fdatasync_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_fdatasync_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_fdatasync_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t oldfd)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_dup_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_dup_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_dup_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* name)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_opendir_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_opendir_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_opendir_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_dirent* entry)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_readdir_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_readdir_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_readdir_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_rewinddir_ocall(uint64_t dirp)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_rewinddir_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_rewinddir_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_rewinddir_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t dirp)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_closedir_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_closedir_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_closedir_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_stat_t* buf)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_stat_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_stat_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_stat_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_stat_t* buf)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_fstat_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_fstat_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_fstat_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int mode)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_access_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_access_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_access_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* newpath)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_link_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_link_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_link_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* pathname)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_unlink_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_unlink_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_unlink_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* newpath)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_rename_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_rename_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_rename_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t length)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_truncate_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_truncate_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_truncate_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t length)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_ftruncate_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_ftruncate_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_ftruncate_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_mode_t mode)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_mkdir_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_mkdir_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_mkdir_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* pathname)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_rmdir_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_rmdir_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_rmdir_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    void* argout)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_fcntl_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_fcntl_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_fcntl_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    void* argout)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_ioctl_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_ioctl_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_ioctl_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int timeout)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_poll_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_poll_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_poll_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int signum)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_kill_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_kill_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_kill_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t sockfd)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_close_socket_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_close_socket_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_close_socket_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int protocol)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_socket_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_socket_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_socket_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t sockfd)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_shutdown_sockets_device_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_shutdown_sockets_device_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_shutdown_sockets_device_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t sv[2])
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_socketpair_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_socketpair_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_socketpair_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t addrlen)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_connect_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_connect_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_connect_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_accept_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_accept_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_accept_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t addrlen)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_bind_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_bind_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_bind_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int backlog)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_listen_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_listen_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_listen_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_recvmsg_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_recvmsg_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_recvmsg_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_sendmsg_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_sendmsg_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_sendmsg_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_recv_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_recv_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_recv_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_recvfrom_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_recvfrom_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_recvfrom_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_send_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_send_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_send_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t addrlen)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_sendto_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_sendto_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_sendto_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_recvv_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_recvv_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_recvv_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_sendv_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_sendv_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_sendv_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int how)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_shutdown_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_shutdown_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_shutdown_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t optlen)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_setsockopt_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_setsockopt_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_setsockopt_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* optlen_out)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_getsockopt_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_getsockopt_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_getsockopt_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_getsockname_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_getsockname_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_getsockname_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_getpeername_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_getpeername_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_getpeername_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t* handle)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_getaddrinfo_open_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_getaddrinfo_open_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_getaddrinfo_open_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    char* ai_canonname)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_getaddrinfo_read_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_getaddrinfo_read_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_getaddrinfo_read_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t handle)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_getaddrinfo_close_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_getaddrinfo_close_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_getaddrinfo_close_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_getnameinfo_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_getnameinfo_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_getnameinfo_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_timespec* rem)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_nanosleep_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_nanosleep_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_nanosleep_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_timespec* rem)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_clock_nanosleep_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_clock_nanosleep_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_clock_nanosleep_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getpid_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_getpid_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_getpid_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_getpid_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getppid_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_getppid_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_getppid_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_getppid_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getpgrp_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_getpgrp_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_getpgrp_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_getpgrp_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getuid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_getuid_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_getuid_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_getuid_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_geteuid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_geteuid_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_geteuid_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_geteuid_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getgid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_getgid_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_getgid_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_getgid_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getegid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_getegid_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_getegid_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_getegid_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int pid)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_getpgid_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_getpgid_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_getpgid_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    unsigned int* list)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_getgroups_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_getgroups_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_getgroups_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_utsname* buf)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_syscall_uname_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_syscall_uname_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_syscall_uname_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    format_ids_t* format_ids)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_get_supported_attester_format_ids_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_get_supported_attester_format_ids_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_get_supported_attester_format_ids_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    sgx_target_info_t* target_info)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_get_qetarget_info_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_get_qetarget_info_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_get_qetarget_info_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* quote_size_out)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_get_quote_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_get_quote_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_get_quote_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* qe_identity_issuer_chain_size_out)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_get_quote_verification_collateral_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_get_quote_verification_collateral_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_get_quote_verification_collateral_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint32_t qe_identity_issuer_chain_size)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_verify_quote_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_verify_quote_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_verify_quote_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t cpuid_table_buffer_size)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_sgx_get_cpuid_table_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_sgx_get_cpuid_table_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_sgx_get_cpuid_table_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* symbols_buffer_size_out)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_sgx_backtrace_symbols_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_sgx_backtrace_symbols_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_sgx_backtrace_symbols_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t self_tcs)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_sgx_thread_wake_wait_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_sgx_thread_wake_wait_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_sgx_thread_wake_wait_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_sgx_wake_switchless_worker_ocall(oe_host_worker_context_t* context)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_sgx_wake_switchless_worker_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_sgx_wake_switchless_worker_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_sgx_wake_switchless_worker_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_sgx_sleep_switchless_worker_ocall(oe_enclave_worker_context_t* context)
{
    ...
    /* Call host function. */
    if (is_pop_call(openfabmap_fcn_id_oe_sgx_sleep_switchless_worker_ocall,0)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_host_function",1,openfabmap_fcn_id_oe_sgx_sleep_switchless_worker_ocall);
        ...
        goto done;
          ...
          if ((_result = oe_call_host_function(
             openfabmap_fcn_id_oe_sgx_sleep_switchless_worker_ocall,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
