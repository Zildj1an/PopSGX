...
static const oe_ecall_info_t _openfabmap_ecall_info_table[] = 
{
    { "open_settings_file" },
...
oe_result_t do_oe_call_enclave_open_settings_file(int func_id)
{
    ...
    open_settings_file_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
 
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(open_settings_file_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(open_settings_file_args_t));
    /* There were no corresponding parameters. */
    ...
    _pargs_in = (open_settings_file_args_t*)_input_buffer;
    ...
    fprintf(stderr, "Calling %s()",_openfabmap_ecall_info_table[func_id].name);
    fprintf(stderr,"...\n");

    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openfabmap_ecall_info_table[func_id].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (open_settings_file_args_t*)_output_buffer;
...
{
  do_oe_call_enclave_open_settings_file,
...
oe_result_t openfabmap_open_settings_file(
    ...
    int* _retval)
{
  ...
  static uint64_t global_id = OE_GLOBAL_ECALL_ID_NULL;
    ...
    if (is_pop_call(openfabmap_fcn_id_open_settings_file,1)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_enclave_function",1,openfabmap_fcn_id_open_settings_file);
        ...
        goto done;
          ...
          if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openfabmap_ecall_info_table[openfabmap_fcn_id_open_settings_file].name,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openfabmap_open_settings_file, open_settings_file);

oe_result_t openfabmap_oe_get_sgx_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    const void* opt_params,
    size_t opt_params_size,
    sgx_report_t* report)
{
  ...
  static uint64_t global_id = OE_GLOBAL_ECALL_ID_NULL;
    ...
    /* Call enclave function. */
    if (is_pop_call(openfabmap_fcn_id_oe_get_sgx_report_ecall,1)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_enclave_function",1,openfabmap_fcn_id_oe_get_sgx_report_ecall);
        ...
        goto done;
          ...
          if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openfabmap_ecall_info_table[openfabmap_fcn_id_oe_get_sgx_report_ecall].name,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openfabmap_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t openfabmap_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    size_t* report_buffer_size)
{
  ...
  static uint64_t global_id = OE_GLOBAL_ECALL_ID_NULL;
    ...
    /* Call enclave function. */
    if (is_pop_call(openfabmap_fcn_id_oe_get_report_v2_ecall,1)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_enclave_function",1,openfabmap_fcn_id_oe_get_report_v2_ecall);
        ...
        goto done;
          ...
          if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openfabmap_ecall_info_table[openfabmap_fcn_id_oe_get_report_v2_ecall].name,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openfabmap_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t openfabmap_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
  ...
  static uint64_t global_id = OE_GLOBAL_ECALL_ID_NULL;
    ...
    /* Call enclave function. */
    if (is_pop_call(openfabmap_fcn_id_oe_verify_local_report_ecall,1)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_enclave_function",1,openfabmap_fcn_id_oe_verify_local_report_ecall);
        ...
        goto done;
          ...
          if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openfabmap_ecall_info_table[openfabmap_fcn_id_oe_verify_local_report_ecall].name,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openfabmap_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t openfabmap_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
  ...
  static uint64_t global_id = OE_GLOBAL_ECALL_ID_NULL;
    ...
    /* Call enclave function. */
    if (is_pop_call(openfabmap_fcn_id_oe_sgx_init_context_switchless_ecall,1)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_enclave_function",1,openfabmap_fcn_id_oe_sgx_init_context_switchless_ecall);
        ...
        goto done;
          ...
          if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openfabmap_ecall_info_table[openfabmap_fcn_id_oe_sgx_init_context_switchless_ecall].name,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openfabmap_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t openfabmap_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
  ...
  static uint64_t global_id = OE_GLOBAL_ECALL_ID_NULL;
    ...
    /* Call enclave function. */
    if (is_pop_call(openfabmap_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall,1)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_enclave_function",1,openfabmap_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall);
        ...
        goto done;
          ...
          if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openfabmap_ecall_info_table[openfabmap_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openfabmap_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);
...
static oe_ocall_func_t _openfabmap_ocall_function_table[] = {
...
oe_result_t __aux_pop_oe_create_openfabmap_enclave(
    const char* path,
    ...
    oe_enclave_t** enclave)
{
    ...
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               _openfabmap_ocall_function_table,
               83,
               _openfabmap_ecall_info_table,
                6,
               enclave);
}
...
{
    char *dummy_path;
    const char *path = "openfabmapenc.signed";
    oe_enclave_type_t type;
    ...
    return __aux_pop_oe_create_openfabmap_enclave(path,type,flags,settings,setting_count,&enclave);
}
...
void handle_call_request_server(int sig,siginfo_t *siginfo,void *context)
{
      ...
      if (!strcmp(func,"__aux_pop_oe_create_openfabmap_enclave")){
            enclave = NULL;
            assert(argc == 6);
            if (verbose_pop_sgx)
...
oe_result_t oe_create_openfabmap_enclave(
    const char* path,
    oe_enclave_type_t type,
    uint32_t flags,
    const oe_enclave_setting_t* settings,
