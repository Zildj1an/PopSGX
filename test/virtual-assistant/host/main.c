...
/*
        ...
        //        fprintf(stderr,"Could not find a text-to-speech program. Echoing messages to console");
                strcpy(TTS,"echo");
        }
*/
  ...
  //    do
    //    {
		...
		// Test PopSGX!!
		fprintf(stderr,"Starting to test PopSGX for email...\n");	
		email();
		fprintf(stderr,"Finished testing PopSGX...\n");
