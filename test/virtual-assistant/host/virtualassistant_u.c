// PopSGX autogenerated file - Carlos Bilbao bilbao {at} vt.edu
/*
...
#include <assert.h>
#include <unistd.h>
#include "virtualassistant_args.h"
...
enum
{
    virtualassistant_fcn_id_b64_enclave_encode = 0,
    virtualassistant_fcn_id_oe_get_sgx_report_ecall = 1,
    virtualassistant_fcn_id_oe_get_report_v2_ecall = 2,
    virtualassistant_fcn_id_oe_verify_local_report_ecall = 3,
    virtualassistant_fcn_id_oe_sgx_init_context_switchless_ecall = 4,
    virtualassistant_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 5,
    virtualassistant_fcn_id_trusted_call_id_max = OE_ENUM_MAX
};

#define MAX_POP_CALL_CUSTOM (1)

/**** Trusted function names. ****/
static const oe_ecall_info_t _virtualassistant_ecall_info_table[] = 
{
    { "b64_enclave_encode" },
...
typedef struct _b64_enclave_encode_args_t
{
...
/**** Trusted function array (PopSGX) ****/

 /* PopSGX generated. Fulfill enclave request from other side. */
oe_result_t do_oe_call_enclave_b64_enclave_encode(int func_id)
{
    ...
    b64_enclave_encode_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
 
    /* Fill marshalling struct. */
    char *src, *res; int len;
    ...
    OE_ADD_SIZE(_input_buffer_size, sizeof(b64_enclave_encode_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(b64_enclave_encode_args_t));
    /* There were no corresponding parameters. */
    ...
    _pargs_in = (b64_enclave_encode_args_t*)_input_buffer;
    ...
    fprintf(stderr, "Calling %s()",_virtualassistant_ecall_info_table[func_id].name);
    fprintf(stderr,"...\n");

    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _virtualassistant_ecall_info_table[func_id].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (b64_enclave_encode_args_t*)_output_buffer;
 ...
 /* PopSGX generated. Fulfill enclave request from other side. */
oe_result_t do_oe_call_enclave_oe_get_sgx_report_ecall(int func_id)
{
    oe_result_t _result = OE_FAILURE;
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
 ...
 /* PopSGX generated. Fulfill enclave request from other side. */
oe_result_t do_oe_call_enclave_oe_get_report_v2_ecall(int func_id)
{
    oe_result_t _result = OE_FAILURE;
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
 ...
 /* PopSGX generated. Fulfill enclave request from other side. */
oe_result_t do_oe_call_enclave_oe_verify_local_report_ecall(int func_id)
{
    oe_result_t _result = OE_FAILURE;
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
 ...
 /* PopSGX generated. Fulfill enclave request from other side. */
oe_result_t do_oe_call_enclave_oe_sgx_init_context_switchless_ecall(int func_id)
{
    oe_result_t _result = OE_FAILURE;
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
 ...
 /* PopSGX generated. Fulfill enclave request from other side. */
oe_result_t do_oe_call_enclave_oe_sgx_switchless_enclave_worker_thread_ecall(int func_id)
{
    oe_result_t _result = OE_FAILURE;
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
...
static oe_result_t (*pop_calls[6])(int) =
{
  do_oe_call_enclave_b64_enclave_encode,
  do_oe_call_enclave_oe_get_sgx_report_ecall,
  do_oe_call_enclave_oe_get_report_v2_ecall,
  do_oe_call_enclave_oe_verify_local_report_ecall,
  do_oe_call_enclave_oe_sgx_init_context_switchless_ecall,
  do_oe_call_enclave_oe_sgx_switchless_enclave_worker_thread_ecall
};
...
oe_result_t virtualassistant_b64_enclave_encode(
    ...
    unsigned char* res)
{
  ...
  static uint64_t global_id = OE_GLOBAL_ECALL_ID_NULL;
    ...
    if (is_pop_call(virtualassistant_fcn_id_b64_enclave_encode,1)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_enclave_function",1,virtualassistant_fcn_id_b64_enclave_encode);
        ...
        goto done;
          ...
          if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _virtualassistant_ecall_info_table[virtualassistant_fcn_id_b64_enclave_encode].name,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(virtualassistant_b64_enclave_encode, b64_enclave_encode);

oe_result_t virtualassistant_oe_get_sgx_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    const void* opt_params,
    size_t opt_params_size,
    sgx_report_t* report)
{
  ...
  static uint64_t global_id = OE_GLOBAL_ECALL_ID_NULL;
    ...
    /* Call enclave function. */
    if (is_pop_call(virtualassistant_fcn_id_oe_get_sgx_report_ecall,1)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_enclave_function",1,virtualassistant_fcn_id_oe_get_sgx_report_ecall);
        ...
        goto done;
          ...
          if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _virtualassistant_ecall_info_table[virtualassistant_fcn_id_oe_get_sgx_report_ecall].name,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(virtualassistant_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t virtualassistant_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    size_t* report_buffer_size)
{
  ...
  static uint64_t global_id = OE_GLOBAL_ECALL_ID_NULL;
    ...
    /* Call enclave function. */
    if (is_pop_call(virtualassistant_fcn_id_oe_get_report_v2_ecall,1)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_enclave_function",1,virtualassistant_fcn_id_oe_get_report_v2_ecall);
        ...
        goto done;
          ...
          if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _virtualassistant_ecall_info_table[virtualassistant_fcn_id_oe_get_report_v2_ecall].name,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(virtualassistant_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t virtualassistant_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
  ...
  static uint64_t global_id = OE_GLOBAL_ECALL_ID_NULL;
    ...
    /* Call enclave function. */
    if (is_pop_call(virtualassistant_fcn_id_oe_verify_local_report_ecall,1)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_enclave_function",1,virtualassistant_fcn_id_oe_verify_local_report_ecall);
        ...
        goto done;
          ...
          if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _virtualassistant_ecall_info_table[virtualassistant_fcn_id_oe_verify_local_report_ecall].name,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(virtualassistant_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t virtualassistant_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
  ...
  static uint64_t global_id = OE_GLOBAL_ECALL_ID_NULL;
    ...
    /* Call enclave function. */
    if (is_pop_call(virtualassistant_fcn_id_oe_sgx_init_context_switchless_ecall,1)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_enclave_function",1,virtualassistant_fcn_id_oe_sgx_init_context_switchless_ecall);
        ...
        goto done;
          ...
          if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _virtualassistant_ecall_info_table[virtualassistant_fcn_id_oe_sgx_init_context_switchless_ecall].name,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(virtualassistant_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t virtualassistant_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
  ...
  static uint64_t global_id = OE_GLOBAL_ECALL_ID_NULL;
    ...
    /* Call enclave function. */
    if (is_pop_call(virtualassistant_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall,1)){
 
        /* Request the other side to execute this call */
        _result = popsgx_call("oe_call_enclave_function",1,virtualassistant_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall);
        ...
        goto done;
          ...
          if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _virtualassistant_ecall_info_table[virtualassistant_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
               _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(virtualassistant_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);

/**** Untrusted function IDs. ****/
enum
{
    virtualassistant_fcn_id_oe_syscall_epoll_create1_ocall = 0,
    virtualassistant_fcn_id_oe_syscall_epoll_wait_ocall = 1,
    virtualassistant_fcn_id_oe_syscall_epoll_wake_ocall = 2,
    virtualassistant_fcn_id_oe_syscall_epoll_ctl_ocall = 3,
    virtualassistant_fcn_id_oe_syscall_epoll_close_ocall = 4,
    virtualassistant_fcn_id_oe_syscall_open_ocall = 5,
    virtualassistant_fcn_id_oe_syscall_read_ocall = 6,
    virtualassistant_fcn_id_oe_syscall_write_ocall = 7,
    virtualassistant_fcn_id_oe_syscall_readv_ocall = 8,
    virtualassistant_fcn_id_oe_syscall_writev_ocall = 9,
    virtualassistant_fcn_id_oe_syscall_lseek_ocall = 10,
    virtualassistant_fcn_id_oe_syscall_pread_ocall = 11,
    virtualassistant_fcn_id_oe_syscall_pwrite_ocall = 12,
    virtualassistant_fcn_id_oe_syscall_close_ocall = 13,
    virtualassistant_fcn_id_oe_syscall_flock_ocall = 14,
    virtualassistant_fcn_id_oe_syscall_fsync_ocall = 15,
    virtualassistant_fcn_id_oe_syscall_fdatasync_ocall = 16,
    virtualassistant_fcn_id_oe_syscall_dup_ocall = 17,
    virtualassistant_fcn_id_oe_syscall_opendir_ocall = 18,
    virtualassistant_fcn_id_oe_syscall_readdir_ocall = 19,
    virtualassistant_fcn_id_oe_syscall_rewinddir_ocall = 20,
    virtualassistant_fcn_id_oe_syscall_closedir_ocall = 21,
    virtualassistant_fcn_id_oe_syscall_stat_ocall = 22,
    virtualassistant_fcn_id_oe_syscall_fstat_ocall = 23,
    virtualassistant_fcn_id_oe_syscall_access_ocall = 24,
    virtualassistant_fcn_id_oe_syscall_link_ocall = 25,
    virtualassistant_fcn_id_oe_syscall_unlink_ocall = 26,
    virtualassistant_fcn_id_oe_syscall_rename_ocall = 27,
    virtualassistant_fcn_id_oe_syscall_truncate_ocall = 28,
    virtualassistant_fcn_id_oe_syscall_ftruncate_ocall = 29,
    virtualassistant_fcn_id_oe_syscall_mkdir_ocall = 30,
    virtualassistant_fcn_id_oe_syscall_rmdir_ocall = 31,
    virtualassistant_fcn_id_oe_syscall_fcntl_ocall = 32,
    virtualassistant_fcn_id_oe_syscall_ioctl_ocall = 33,
    virtualassistant_fcn_id_oe_syscall_poll_ocall = 34,
    virtualassistant_fcn_id_oe_syscall_kill_ocall = 35,
    virtualassistant_fcn_id_oe_syscall_close_socket_ocall = 36,
    virtualassistant_fcn_id_oe_syscall_socket_ocall = 37,
    virtualassistant_fcn_id_oe_syscall_shutdown_sockets_device_ocall = 38,
    virtualassistant_fcn_id_oe_syscall_socketpair_ocall = 39,
    virtualassistant_fcn_id_oe_syscall_connect_ocall = 40,
    virtualassistant_fcn_id_oe_syscall_accept_ocall = 41,
    virtualassistant_fcn_id_oe_syscall_bind_ocall = 42,
    virtualassistant_fcn_id_oe_syscall_listen_ocall = 43,
    virtualassistant_fcn_id_oe_syscall_recvmsg_ocall = 44,
    virtualassistant_fcn_id_oe_syscall_sendmsg_ocall = 45,
    virtualassistant_fcn_id_oe_syscall_recv_ocall = 46,
    virtualassistant_fcn_id_oe_syscall_recvfrom_ocall = 47,
    virtualassistant_fcn_id_oe_syscall_send_ocall = 48,
    virtualassistant_fcn_id_oe_syscall_sendto_ocall = 49,
    virtualassistant_fcn_id_oe_syscall_recvv_ocall = 50,
    virtualassistant_fcn_id_oe_syscall_sendv_ocall = 51,
    virtualassistant_fcn_id_oe_syscall_shutdown_ocall = 52,
    virtualassistant_fcn_id_oe_syscall_setsockopt_ocall = 53,
    virtualassistant_fcn_id_oe_syscall_getsockopt_ocall = 54,
    virtualassistant_fcn_id_oe_syscall_getsockname_ocall = 55,
    virtualassistant_fcn_id_oe_syscall_getpeername_ocall = 56,
    virtualassistant_fcn_id_oe_syscall_getaddrinfo_open_ocall = 57,
    virtualassistant_fcn_id_oe_syscall_getaddrinfo_read_ocall = 58,
    virtualassistant_fcn_id_oe_syscall_getaddrinfo_close_ocall = 59,
    virtualassistant_fcn_id_oe_syscall_getnameinfo_ocall = 60,
    virtualassistant_fcn_id_oe_syscall_nanosleep_ocall = 61,
    virtualassistant_fcn_id_oe_syscall_clock_nanosleep_ocall = 62,
    virtualassistant_fcn_id_oe_syscall_getpid_ocall = 63,
    virtualassistant_fcn_id_oe_syscall_getppid_ocall = 64,
    virtualassistant_fcn_id_oe_syscall_getpgrp_ocall = 65,
    virtualassistant_fcn_id_oe_syscall_getuid_ocall = 66,
    virtualassistant_fcn_id_oe_syscall_geteuid_ocall = 67,
    virtualassistant_fcn_id_oe_syscall_getgid_ocall = 68,
    virtualassistant_fcn_id_oe_syscall_getegid_ocall = 69,
    virtualassistant_fcn_id_oe_syscall_getpgid_ocall = 70,
    virtualassistant_fcn_id_oe_syscall_getgroups_ocall = 71,
    virtualassistant_fcn_id_oe_syscall_uname_ocall = 72,
    virtualassistant_fcn_id_oe_get_supported_attester_format_ids_ocall = 73,
    virtualassistant_fcn_id_oe_get_qetarget_info_ocall = 74,
    virtualassistant_fcn_id_oe_get_quote_ocall = 75,
    virtualassistant_fcn_id_oe_get_quote_verification_collateral_ocall = 76,
    virtualassistant_fcn_id_oe_verify_quote_ocall = 77,
    virtualassistant_fcn_id_oe_sgx_get_cpuid_table_ocall = 78,
    virtualassistant_fcn_id_oe_sgx_backtrace_symbols_ocall = 79,
    virtualassistant_fcn_id_oe_sgx_thread_wake_wait_ocall = 80,
    virtualassistant_fcn_id_oe_sgx_wake_switchless_worker_ocall = 81,
    virtualassistant_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 82,
    virtualassistant_fcn_id_untrusted_call_max = OE_ENUM_MAX
};
...
static oe_ocall_func_t _virtualassistant_ocall_function_table[] = {
...
oe_result_t __aux_pop_oe_create_virtualassistant_enclave(
    const char* path,
    ...
    oe_enclave_t** enclave)
{
    ...
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               _virtualassistant_ocall_function_table,
               83,
               _virtualassistant_ecall_info_table,
                6,
               enclave);
}
...
void busy_wait_server(FILE *aux){
    ...
    int ret;
    char *name= "virtualassistanthost";
    char func[100]; 
...
{
    char *dummy_path;
    const char *path = "virtualassistantenc.signed";
    oe_enclave_type_t type;
    ...
    return __aux_pop_oe_create_virtualassistant_enclave(path,type,flags,settings,setting_count,&enclave);
}
...
void handle_call_request_server(int sig,siginfo_t *siginfo,void *context)
{
      ...
      if (!strcmp(func,"__aux_pop_oe_create_virtualassistant_enclave")){
            enclave = NULL;
            assert(argc == 6);
            if (verbose_pop_sgx)
...
oe_result_t oe_create_virtualassistant_enclave(
    const char* path,
    oe_enclave_type_t type,
    uint32_t flags,
    const oe_enclave_setting_t* settings,
