 ...
 */
#ifndef EDGER8R_POP_VIRTUALASSISTANT_U_H
#define EDGER8R_POP_VIRTUALASSISTANT_U_H
...
unsigned char *user_block; // File encryption
...
/**** ECALL prototypes. ****/
oe_result_t b64_enclave_encode(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
...
#endif // EDGER8R_POP_VIRTUALASSISTANT_U_H
